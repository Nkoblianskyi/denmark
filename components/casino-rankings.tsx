...
export function CasinoRankings() {
  ...
  return (
    <section id="rankings" className="py-3 bg-black">
                  ...
                  <div className="flex items-center justify-between gap-0 w-full">
                    ...
                    <div className="flex items-center gap-6 w-72">
                      ...
                      <div className="text-center flex-1">
                        ...
                        <div>
                          {casino.isTopChoice && (
                            <Badge className="bg-yellow-400 text-black font-semibold text-xs mb-1">#1 CHOICE</Badge>
                          )}
                        </div>
                        {/* Logo */}
                    ...
                    {/* Center Column: Bonus + Rating */}
                    <div className="text-center px-0 w-84">
                      {/* Bonus */}
                      <div className="mb-4">
                    ...
                    <div className="flex flex-col gap-3 w-32">
                      {casino.features.map((feature, index) => (
                        <Badge
                          key={index}
                          variant="outline"
                          className="border-red-900/50 text-gray-300 bg-red-950/20 text-xs px-3 py-2 text-center whitespace-nowrap"
                        >
                          {feature}
                        </Badge>
                      ))}
